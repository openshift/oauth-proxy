...
Usage of oauth-proxy:
  ...
  -htpasswd-file string: additionally authenticate against a htpasswd file. Entries must be created with "htpasswd -s" for SHA encryption or "htpasswd -B" for Bcrypt encryption (preferred)
