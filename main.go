...
func main() {
	...
	flagSet.String("tls-min-version", "", "minimum TLS version (e.g., VersionTLS12, VersionTLS13). If not set, uses secure default (TLS 1.2)")
	flagSet.StringVar(&tlsCipherSuitesStr, "tls-cipher-suites", "", "comma-separated list of TLS cipher suites to support (e.g., TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256). If not set, uses secure defaults")
